...
search.addEventListener('click', () => {
  (0,_populate__WEBPACK_IMPORTED_MODULE_1__.showWeather)(location.value);
});
...
toggle.addEventListener('change', () => {
  (0,_populate__WEBPACK_IMPORTED_MODULE_1__.toggleTemperature)(toggle.valueAsNumber);
});
